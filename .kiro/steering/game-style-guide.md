...
### Primary Colors
- **Green-500**: `#5CB54D` - Main brand color for primary buttons, CTAs, and key highlights
- **Green-400**: Lighter green for hover states and secondary accents
- **Green-300**: Lightest green for text links and subtle highlights
...
- Ask user about how Gravity should work 